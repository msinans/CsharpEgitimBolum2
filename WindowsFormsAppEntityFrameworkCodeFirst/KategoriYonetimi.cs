...
namespace WindowsFormsAppEntityFrameworkCodeFirst
{
    public partial class KategoriYonetimi : Form
    {
        ...
        private void dgvKategoriler_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                txtKategoriAdi.Text = dgvKategoriler.CurrentRow.Cells[1].Value.ToString(); // 0'da id var o yüzden 1 yazdık
        ...
        private void btnGuncelle_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("Kayıt Başarılı"); // bunu if şartı ile yapmak daha garanti okur ancak bu da çalışır
        ...
        private void btnSil_Click(object sender, EventArgs e)
        {
            ...
            {
                int id = Convert.ToInt32(dgvKategoriler.CurrentRow.Cells[0].Value);
                Kategori kategori = context.Kategoriler.SingleOrDefault(k => k.Id == id); // SingleOrDefault mtodu veritabanındaki 1 kaydı getirmek için kullanılır, eğer şarta uyan 1 den fazla kayıt bulursa hata verir.
